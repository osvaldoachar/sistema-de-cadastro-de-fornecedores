...
<body>
    <div class="container">
        <div class="tittle">Cadastro de Fornecedor </div><div class="linkLista"><a href="listaFornecedores.jsp" class="verLista">Ver Lista</a></div>

        <form action="controle/inserirControle.jsp" method="post">
            <div class="user-detail">
                <div class="input-box">
                    <span class="detail">Código:</span>
                    <input type="text" name="codigo" placeholder="Não precisa preencher" readonly="readonly" class="theCode" >
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <input type="date" name="dataNascimento" id="dataNascimento" placeholder="Ano-Mês-Dia" required style="color: grey;">
                </div>
                <div class="input-box">
    ...
    <div class="outrapage">
    <%@include file="listaFornecedores.jsp" %>
    </div>
</body>
</html>