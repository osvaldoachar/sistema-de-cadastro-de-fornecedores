...
.container .tittle::before{
    ...
    height: 3px;
    width: 45px;
    background: linear-gradient(135deg, #d80000, #ec9f9f);
}
...
form .button input[type="reset"]{
    background: linear-gradient(145deg, #f86e6e, #d80000);
}
form .button input[type="reset"]:hover{
    background: linear-gradient(145deg, #f86e6e, #ff0505);
}
...
<body>
    <div class="container">
        <div class="tittle">Atualização de Fornecedor</div>

        <form action="controle/atualizarControle.jsp" method="post">
            <div class="user-detail">
                <div class="input-box">
                    <span class="detail">Código:</span>
                    <input type="text" name="codigo" placeholder="Não precisa preencher" readonly="readonly" class="theCode" value="${fornecedor.codigo }"  >
                </div>
                <div class="input-box">
                    <span class="detail">Nome:</span>
                    <input type="text" name="nome" placeholder="Digite o seu primeiro nome"  class="outrosIn" required value="${fornecedor.nome }">
                </div>
                <div class="input-box">
                    <span class="detail">Apelido:</span>
                    <input type="text" name="apelido" placeholder="Digite o seu apelido" required value="${fornecedor.apelido }">
                </div>
                <div class="input-box">
                    <span class="detail">Endereço:</span>
                    <input type="text" name="endereco" placeholder="Digite o seu endereço" required value="${fornecedor.endereco }">
                </div>
                <div class="input-box">
                    <span class="detail">Data de Nascimento:</span>
                    <input type="date" name="dataNascimento" id="dataNascimento" placeholder="Ano-Mês-Dia" required value="${fornecedor.dataNascimento }">
                </div>
                <div class="input-box">
                    <span class="detail">Nacionalidade:</span>
                    <select name="nacionalidade" id="nacionalidade" required>
                        <option disabled selected value="" style="background: #d80000; color: #fff;">Selecione um País</option>
                ...
                <div class="input-box">
                    ...
                    <input type="email" name="email" id="email" placeholder="Digite o seu e-mail" required value="${fornecedor.email }">
                </div>
                <div class="input-box">
                    <span class="detail">Telefone:</span>
                    <input type="tel" name="telefone" id="telefone" placeholder="Digite o seu número de telefone" required value="${fornecedor.telefone }">
                </div>
            </div>
            <div class="gender-detail">
                <input type="radio" name="genero" id="dot-1" value="Masculino" ${fornecedor.genero ==  "Masculino"}>
                <input type="radio" name="genero" id="dot-2" value="Feminino" ${fornecedor.genero == "Feminino"}>
                <input type="radio" name="genero" id="dot-3" value="Indefinido" ${fornecedor.genero == "Indefinido"}>
