...
public class FornecedorDAO extends ConexaoDAO {
	...
	public ArrayList<Fornecedor> getLista() throws Exception{
		...
		String chamarTodos = "SELECT * from fornecedores order by codigo DESC";
	...
	//CRIACAO DO METODO INSERIR
		public void InserirFornecedorDAO(String codigo, String nome, String apelido, String genero, String endereco, String dataNascimento,
				String nacionalidade, String email, String telefone) throws Exception {
		...
		public Fornecedor getPorCodigo(int codigo) throws Exception{
